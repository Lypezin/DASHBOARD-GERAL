-- =====================================================================
-- 🚀 SOLUÇÃO COMPLETA - VERSÃO CORRIGIDA (SEM ERROS)
-- =====================================================================
-- ✅ Copie e cole TUDO de uma vez
-- ✅ Sem erros de RLS em materialized view
-- =====================================================================

-- 1. DESABILITAR RLS (APENAS TABELAS)
ALTER TABLE public.dados_corridas DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.user_profiles DISABLE ROW LEVEL SECURITY;

-- 2. RECRIAR MATERIALIZED VIEW (LIMPAR ANTES)
...
-- 5. RECRIAR dashboard_resumo (CORRIGIDO - ARRAYS)
...
-- 6. RECRIAR calcular_utr (OTIMIZADO)
...
SELECT (public.dashboard_resumo(NULL, NULL, NULL, NULL, NULL)->'totais') as totais;
SELECT jsonb_typeof((public.dashboard_resumo(NULL, NULL, NULL, NULL, NULL))->'dimensoes'->'pracas') as tipo_pracas;
SELECT (public.calcular_utr(NULL, NULL, NULL, NULL, NULL)->'geral') as utr_geral;
