...
-- =====================================================================
-- PROBLEMA 1: Horas planejadas incorretas (usar método Excel DISTINCT)
-- PROBLEMA 2: Admin timeout (estratégia: carregar SÓ agregados, sem detalhes)
-- =====================================================================

-- Função listar_todas_semanas
...
-- =====================================================================
-- Dashboard Resumo - ULTRA OTIMIZADO
-- =====================================================================
...
BEGIN
  ...
  -- Com filtro: 52 semanas, sem filtro: 3 semanas (MUITO REDUZIDO para admin)
...
-- MUDANÇAS CRÍTICAS:
-- =====================================================================
-- ✅ SEMANAL: USA MÉTODO EXCEL (DISTINCT antes de calcular)
-- ✅ DIA/TURNO/SUB_PRACA: USA tempo_disponivel_escalado_segundos (OK)
-- ✅ LIMITE ADMIN: 3 semanas sem filtro (MUITO REDUZIDO)
-- ✅ TIMEOUT: 25s (reduzido de 30s)
-- ✅ work_mem: 32MB (reduzido de 48MB)
