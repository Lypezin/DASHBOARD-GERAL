-- =====================================================================
-- CORREÇÕES URGENTES - 3 PROBLEMAS
-- =====================================================================
-- 1. Turnos sem nome na aderência detalhada
-- 2. Semanas não aparecem na guia Comparação  
-- 3. Timeout (57014) para admin com todas as cidades
-- =====================================================================

-- =====================================================================
-- PROBLEMA 1: Verificar se a coluna 'periodo' está vindo corretamente
-- =====================================================================
-- Testar se periodo está vazio ou NULL
SELECT 
  periodo,
  COUNT(*) as quantidade
FROM dados_corridas
...
-- =====================================================================
-- Esta função DEVE retornar array de números de semanas (não strings)
...
-- =====================================================================
-- Estratégia:
-- 1. Usar LIMIT menor para admin sem filtros (52 -> 15)
-- 2. Reduzir ainda mais work_mem (128MB -> 64MB)
-- 3. Adicionar índice composto otimizado
-- =====================================================================

-- 3.1: Criar índice composto para queries de admin
...
-- 3.2: Atualizar estatísticas
ANALYZE dados_corridas;

-- 3.3: Recriar dashboard_resumo com otimizações agressivas
...
-- =====================================================================
-- ✅ PROBLEMA 1 (Turnos): Adicionado COALESCE(periodo, 'Sem Turno') 
--    para garantir que sempre mostre um nome
--
-- ✅ PROBLEMA 2 (Comparação): Recriada listar_todas_semanas() 
--    retornando INTEGER[] em vez de strings
--
-- ✅ PROBLEMA 3 (Timeout Admin): 
--    - Limite padrão: 52 -> 10 semanas
--    - Com QUALQUER filtro: volta para 52
--    - work_mem: 64MB (reduzido de 128MB)
--    - statement_timeout: 45s (reduzido de 60s)
--    - Novo índice composto otimizado para admin
-- =====================================================================
