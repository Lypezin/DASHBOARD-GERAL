-- =====================================================================
-- CORREÇÃO: Adicionar filtro de semana na consulta semanal
-- =====================================================================
-- Bug: a consulta 'semanal' não estava aplicando p_semana
-- Resultado: Mesmo filtrando uma semana, retornava todas
-- =====================================================================
      ...
      FROM (
        ...
        FROM (
          ...
          WHERE (p_ano IS NULL OR dc.ano_iso = p_ano)
            AND (p_semana IS NULL OR dc.semana_numero = p_semana) -- 🔥 ADICIONADO ESTE FILTRO!
            ...
            (
              ...
              FROM (
                SELECT DISTINCT
                  ...
                  numero_minimo_de_entregadores_regulares_na_escala
                FROM dados_corridas dc2
                WHERE EXTRACT(ISODOW FROM dc2.data_do_periodo) = EXTRACT(ISODOW FROM dc.data_do_periodo)
...
-- FIM DA CORREÇÃO
-- =====================================================================
-- ✅ Agora ao filtrar semana 35, retorna APENAS semana 35 no array semanal
-- ✅ Frontend calculará aderência geral corretamente
-- =====================================================================
