    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-6xl w-full h-[95vh] flex flex-col">
        ...
        <div className="sticky top-0 bg-white p-4 border-b border-slate-200 flex justify-between items-center z-10">
          <h3 className="text-xl font-bold text-slate-800">Apresentação de Resultados</h3>
        ...
        <div ref={contentRef} className="bg-slate-100 flex-1 overflow-hidden p-4">
          {/* Container do Slide com ajuste de escala */}
          <div className="w-full h-full flex items-center justify-center">
            <div 
              ...
              style={{ 
                width: '1920px', 
                height: '1080px', 
                transform: `scale(0.55)` // Ajuste a escala conforme necessário para o preview
              }}
            >
                        ...
                        <div className="bg-white bg-opacity-15 rounded-3xl p-6 space-y-4 w-[450px]">
                          ...
                          <div className="space-y-3 text-2xl opacity-90">
                            <div className="flex justify-between items-center bg-white bg-opacity-10 rounded-xl p-3">
                              <span>🚗 Corridas:</span>
                              <span className="font-bold text-yellow-300">{semana1?.totais?.corridas_completadas || 0} / {semana1?.totais?.corridas_ofertadas || 0}</span>
                            </div>
                            <div className="flex justify-between items-center bg-white bg-opacity-10 rounded-xl p-3">
                            ...
                            <div className="flex justify-between items-center bg-white bg-opacity-10 rounded-xl p-3">
                              ...
                              <span className="font-bold text-red-300">{semana1?.totais?.corridas_rejeitadas || 0}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="bg-white bg-opacity-15 rounded-3xl p-6 space-y-4 w-[450px]">
                          ...
                          <div className="space-y-3 text-2xl opacity-90">
                            <div className="flex justify-between items-center bg-white bg-opacity-10 rounded-xl p-3">
                              <span>🚗 Corridas:</span>
                              <div>
                                <span className="font-bold text-yellow-300">{semana2?.totais?.corridas_completadas || 0} / {semana2?.totais?.corridas_ofertadas || 0}</span>
                            ...
                            <div className="w-full flex justify-around items-center">
                              ...
                              <div className="text-center">
                                <div className="relative w-32 h-32 mb-3">
                                  ...
                                  <div className="absolute inset-0 flex items-center justify-center">
                                    <span className="text-2xl font-black leading-none">{aderencia1.toFixed(0)}%</span>
                                  </div>
                                </div>
                              ...
                              <div className="text-center">
                                <div className="relative w-32 h-32 mb-3">
                                  ...
                                  <div className="absolute inset-0 flex items-center justify-center">
                                    <span className="text-2xl font-black leading-none">{aderencia2.toFixed(0)}%</span>
                                  </div>
                                </div>
                            ...
                            return (
                              <div key={index} className="text-center bg-white bg-opacity-15 rounded-2xl p-4 w-48">
                                ...
                                <div className="relative w-28 h-28 mx-auto mb-3">
                                  ...
                                  <div className="absolute inset-0 flex items-center justify-center">
                                    <span className="text-2xl font-black leading-none">{aderencia.toFixed(0)}%</span>
                                  </div>
                                </div>
                        ...
                        <div className="w-full flex justify-center items-center gap-12">
                          ...
                          <div className="bg-white bg-opacity-15 p-8 rounded-3xl w-[800px] flex flex-col items-center">
                            ...
                            <div className="w-full flex justify-around">
                              {/* ... Lógica para semana 1 do turnoPar1 ... */}
                              <div className="text-center">
                                <div className="text-3xl font-bold mb-4">SEM {numeroSemana1}</div>
                                <div className="relative w-48 h-48 mb-4">
                                   {/* SVG e dados aqui */}
                                </div>
                                <div className="text-2xl font-medium">{/* Horas aqui */}</div>
                              </div>
                               {/* ... Lógica para semana 2 do turnoPar1 ... */}
                               <div className="text-center">
                                ...
                                <div className="text-2xl font-medium">{/* Horas aqui */}</div>
                                <div className="mt-2 space-y-1 text-xl font-bold">{/* Diferenças aqui */}</div>
                              </div>
                            </div>
                          </div>
                          ...
                          {turnoPar2 && (
                            <div className="bg-white bg-opacity-15 p-8 rounded-3xl w-[800px] flex flex-col items-center">
                              ...
                              <div className="w-full flex justify-around">
                                {/* ... Lógica para semana 1 do turnoPar2 ... */}
                                <div className="text-center">
                                  <div className="text-3xl font-bold mb-4">SEM {numeroSemana1}</div>
                                  <div className="relative w-48 h-48 mb-4">
                                     {/* SVG e dados aqui */}
                                 ...
                                 {/* ... Lógica para semana 2 do turnoPar2 ... */}
                                 <div className="text-center">
                                  <div className="text-3xl font-bold mb-4">SEM {numeroSemana2}</div>
                                  <div className="relative w-48 h-48 mb-4">
                                     {/* SVG e dados aqui */}
