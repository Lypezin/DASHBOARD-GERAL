...
export const DashboardLoadingState = React.memo(function DashboardLoadingState() {
  return (
    <div className="space-y-4 animate-fade-in">
      <div className="rounded-3xl border border-slate-200/70 bg-white/86 px-4 py-3 shadow-[0_16px_40px_-34px_rgba(15,23,42,0.6)] backdrop-blur dark:border-slate-800/70 dark:bg-slate-900/82">
        <div className="flex items-center gap-3 text-sm font-semibold text-slate-600 dark:text-slate-300">
          ...
          <div>
            ...
            <p className="text-xs font-medium text-slate-500 dark:text-slate-400">
              Carregando filtros, visoes e indicadores do dashboard.
            </p>
          </div>
        </div>
      </div>
