...
export const DashboardErrorState = React.memo(function DashboardErrorState({
  ...
  return (
    <div className="flex h-[60vh] items-center justify-center px-4 sm:h-[70vh] animate-fade-in">
      <div className="w-full max-w-xl rounded-[2rem] border border-rose-200/80 bg-white/92 p-7 text-center shadow-[0_30px_80px_-50px_rgba(244,63,94,0.45)] backdrop-blur dark:border-rose-900/50 dark:bg-slate-900/88 dark:shadow-black/30 sm:p-9">
