...
export const DashboardErrorState = React.memo(function DashboardErrorState({
  ...
  return (
    <div className="flex h-[60vh] sm:h-[70vh] items-center justify-center animate-fade-in">
      <div className="max-w-sm sm:max-w-md mx-auto rounded-xl sm:rounded-2xl border border-rose-200 bg-white p-6 sm:p-8 text-center shadow-md dark:border-rose-900 dark:bg-slate-900">
        ...
        <button
          ...
          className="mt-6 rounded-lg sm:rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-5 sm:px-6 py-2 sm:py-2.5 text-sm sm:text-base font-semibold text-white shadow-md transition-[box-shadow,transform] duration-150 hover:shadow-lg hover:scale-[1.01] active:scale-[0.99]"
        >
          Tentar novamente
        </button>
      </div>
