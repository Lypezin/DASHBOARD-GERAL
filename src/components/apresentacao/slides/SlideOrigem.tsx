...
const SlideOrigem: React.FC<SlideOrigemProps> = ({
  ...
  return (
    <SlideWrapper isVisible={isVisible} style={{ padding: '20px 40px' }}>
      {/* Header */}
      ...
      {/* Cards Grid - 3x2 layout with larger content */}
        ...
        {itens.map((item) => (
          ...
          >
            ...
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-base font-bold uppercase tracking-wide text-slate-800 truncate max-w-[60%]">
                {item.nome}
              </h3>
              <div className="rounded-lg bg-blue-50 border border-blue-200 px-2.5 py-1">
                ...
                <span className="text-sm font-bold text-blue-700 leading-tight" style={buildTimeTextStyle(item.horasPlanejadas, 0.875)}>
