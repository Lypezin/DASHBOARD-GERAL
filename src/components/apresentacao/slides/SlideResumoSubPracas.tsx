...
interface SlideResumoSubPracasProps {
    isVisible: boolean;
...
const SlideResumoSubPracas: React.FC<SlideResumoSubPracasProps> = ({
    isVisible,
    numeroSemana1,
    numeroSemana2,
    paginaAtual,
    ...
    return (
        <SlideWrapper isVisible={isVisible} style={{ padding: '32px 48px' }}>
            <SlideHeader
                title="TABELA RESUMO DE SUB-PRAÇAS"
                    ...
                    <table className="w-full border-collapse">
                        <thead>
                            ...
                            <tr className="bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-sm font-bold uppercase border-b-2 border-slate-200 dark:border-slate-700">
                                <th className="px-6 py-4 text-left font-extrabold text-blue-600 dark:text-blue-400">Sub-Praça</th>
...
export default SlideResumoSubPracas;
