    ...
    return (
        <div className="flex flex-col items-center gap-2.5">
            ...
            <div className="flex flex-col gap-2 w-full mt-2">
                {horasPlanejadas && (
                    <div className="bg-sky-50 dark:bg-sky-900/20 border border-sky-100 dark:border-sky-800/50 rounded-lg px-4 py-2 text-center min-w-[120px] animate-float-up" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
                ...
                {horasEntregues && (
                    <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800/50 rounded-lg px-4 py-2 text-center min-w-[120px] animate-float-up" style={{ animationDelay: '350ms', animationFillMode: 'forwards' }}>
