    ...
    return (
        <div className="mt-4 space-y-3">
            ...
            <div className="flex items-center justify-between py-1">
                <span className="text-sm text-slate-500 dark:text-slate-400">Custo por Liberado</span>
                ...
                <div className={`flex items-center gap-3 rounded-xl px-4 py-3 ${
                    ...
                    {metaInfoAtendente.jaAtingiuMeta ? (
                        <>
                            ...
                            <div>
                                <p className="text-sm font-semibold text-emerald-700 dark:text-emerald-300">Meta atingida</p>
