...
export const ResultadosErrorState: React.FC<Props> = ({ error }) => {
    return (
        <div className="flex h-[60vh] items-center justify-center">
            <div className="mx-auto max-w-md rounded-[1.8rem] border border-rose-200/80 bg-white/95 p-6 text-center shadow-[0_20px_52px_-38px_rgba(190,24,93,0.3)] dark:border-rose-900/40 dark:bg-slate-950/80">
