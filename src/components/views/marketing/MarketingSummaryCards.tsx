...
export const MarketingSummaryCards = React.memo(function MarketingSummaryCards({ totals }: MarketingSummaryCardsProps) {
    ...
    const cardsConfig = [
        ...
        { title: 'Entregadores', icon: Users, value: (totals.entregadores_ops + totals.entregadores_mkt).toLocaleString('pt-BR'), opsValue: totals.entregadores_ops.toLocaleString('pt-BR'), mktValue: totals.entregadores_mkt.toLocaleString('pt-BR'), opsPercent: calculatePercentage(totals.entregadores_ops, totals.entregadores_ops + totals.entregadores_mkt), mktPercent: calculatePercentage(totals.entregadores_mkt, totals.entregadores_ops + totals.entregadores_mkt), colorClass: 'text-sky-600 dark:text-sky-300', bgClass: 'bg-gradient-to-br from-sky-50 to-white dark:from-sky-900/20 dark:to-slate-900', iconBgClass: 'bg-sky-100 dark:bg-sky-900/40' },
