                    ...
                    <div className="grid grid-cols-4 gap-3">
                        ...
                        <div className="bg-white dark:bg-slate-800/80 rounded-xl border border-emerald-100 dark:border-emerald-900/30 p-3 text-center">
                            ...
                            <div className="flex items-center justify-center gap-3 text-[11px]">
                                <span className="flex items-center gap-1 text-slate-500">
                                    ...
                                    <b className="text-slate-700 dark:text-slate-200">{item.entradas_marketing || 0}</b>
                                </span>
                                <span className="flex items-center gap-1 text-slate-500">
                        ...
                        <div className="bg-white dark:bg-slate-800/80 rounded-xl border border-indigo-100 dark:border-indigo-900/30 p-3 text-center">
                            ...
                            <div className="flex items-center justify-center gap-3 text-[11px]">
                                <span className="flex items-center gap-1 text-slate-500">
                                    <Megaphone className="w-3 h-3 text-blue-400" />
                                    <b className="text-slate-700 dark:text-slate-200">{item.retomada_marketing || 0}</b>
                                </span>
                                <span className="flex items-center gap-1 text-slate-500">
                                    <Wrench className="w-3 h-3 text-slate-400" />
                        ...
                        <div className="bg-white dark:bg-slate-800/80 rounded-xl border border-rose-100 dark:border-rose-900/30 p-3 text-center">
                            ...
                            <div className="flex items-center justify-center gap-3 text-[11px]">
                                <span className="flex items-center gap-1 text-slate-500">
                                    <Megaphone className="w-3 h-3 text-blue-400" />
                                    <b className="text-slate-700 dark:text-slate-200">{item.saidas_marketing || 0}</b>
                                </span>
                                <span className="flex items-center gap-1 text-slate-500">
                                    <Wrench className="w-3 h-3 text-slate-400" />
                        ...
                        <div className={`bg-white dark:bg-slate-800/80 rounded-xl border p-3 text-center ${(item.saidas_novos || 0) > 0 ? 'border-amber-200 dark:border-amber-900/30' : 'border-slate-100 dark:border-slate-800'}`}>
                            ...
                            <div className={`text-xl font-bold tabular-nums mb-1 ${(item.saidas_novos || 0) > 0 ? 'text-amber-700 dark:text-amber-300' : 'text-slate-400'}`}>
                                {item.saidas_novos || 0}
                            </div>
