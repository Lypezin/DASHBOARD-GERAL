    ...
    switch (themeName) {
        ...
        case 'orange':
            return {
                ...
                bg: 'bg-gradient-to-br from-orange-50 to-white dark:from-orange-900/20 dark:to-slate-900',
        ...
        default:
            return {
                ...
                bg: 'bg-gradient-to-br from-sky-50 to-white dark:from-sky-950/30 dark:to-slate-900',
