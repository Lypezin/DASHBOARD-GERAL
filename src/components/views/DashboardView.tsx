                ...
                {aderenciaDiaOrdenada.map((dia, index) => {
                  ...
                  return (
                    <div key={`dia-${index}`} className="relative group/card min-w-0">
                      ...
                      <Card
                        className={`relative border-0 shadow-lg bg-gradient-to-br from-white to-blue-50/50 dark:from-slate-800 dark:to-blue-950/20 rounded-2xl overflow-hidden backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-xl ${isToday ? 'ring-2 ring-blue-400/50' : ''
                          }`}
                      >
