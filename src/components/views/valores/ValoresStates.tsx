...
export const ValoresError = ({ error }: { error: string }) => (
    <div className="flex h-[60vh] items-center justify-center px-4 motion-safe:animate-fade-in">
...
export const ValoresEmpty = () => (
    <div className="flex flex-col items-center justify-center rounded-[2rem] border border-dashed border-slate-300/80 bg-white/75 px-6 py-14 text-center shadow-sm motion-safe:animate-fade-in dark:border-slate-700/80 dark:bg-slate-900/45">
