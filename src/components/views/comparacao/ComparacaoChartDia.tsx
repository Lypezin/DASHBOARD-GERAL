...
export const ComparacaoChartDia = React.memo(function ComparacaoChartDia({
    dadosComparacao,
    semanasSelecionadas,
}: ComparacaoChartDiaProps) {
    const data = useMemo(() => ({
        labels: DIAS_CHART,
...
ComparacaoChartDia.displayName = 'ComparacaoChartDia';
