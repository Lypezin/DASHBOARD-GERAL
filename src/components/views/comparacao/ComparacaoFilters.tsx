    ...
    return (
        <SaasPanel className="overflow-visible">
            <SaasPanelHeader
                ...
                icon={BarChart3}
                actions={(
                    <div className="flex min-w-0 flex-wrap items-center justify-start gap-2 sm:justify-end sm:gap-2.5">
                        ...
                        {semanasSelecionadas.length > 0 ? (
                            <button
                                ...
                                type="button"
                                className="inline-flex h-9 items-center gap-2 rounded-xl border border-slate-200/80 bg-white px-3 text-[10px] font-bold uppercase tracking-[0.14em] text-slate-500 shadow-sm transition-[background-color,border-color,color,box-shadow,transform] duration-200 hover:-translate-y-0.5 hover:border-rose-200 hover:bg-rose-50 hover:text-rose-600 dark:border-slate-800/80 dark:bg-slate-950 dark:text-slate-400 dark:hover:border-rose-800 dark:hover:bg-rose-950/20 dark:hover:text-rose-400 sm:h-10 sm:px-4 sm:text-[11px] sm:tracking-[0.16em]"
                            >
