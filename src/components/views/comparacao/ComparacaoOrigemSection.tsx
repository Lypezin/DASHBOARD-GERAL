      ...
      <CardHeader className="relative z-10 pb-6">
        <div className="flex flex-col gap-4 items-center">
          <div className="flex items-center gap-4">
            <div className="p-3.5 bg-gradient-to-br from-fuchsia-500 to-rose-600 rounded-2xl shadow-lg shadow-fuchsia-500/30 ring-1 ring-white/20 dark:ring-white/10 group-hover:scale-105 transition-transform duration-300">
