...
const mapDiasFull: Record<string, string> = { 'monday': 'segunda', 'segunda': 'segunda', 'seg': 'segunda', 'tuesday': 'terca', 'terca': 'terca', 'ter': 'terca', 'terça': 'terca', 'wednesday': 'quarta', 'quarta': 'quarta', 'qua': 'quarta', 'thursday': 'quinta', 'quinta': 'quinta', 'qui': 'quinta', 'friday': 'sexta', 'sexta': 'sexta', 'sex': 'sexta', 'saturday': 'sabado', 'sabado': 'sabado', 'sab': 'sabado', 'sábado': 'sabado', 'sunday': 'domingo', 'domingo': 'domingo', 'dom': 'domingo' };
const mapIso: Record<number, string> = { 1: 'segunda', 2: 'terca', 3: 'quarta', 4: 'quinta', 5: 'sexta', 6: 'sabado', 7: 'domingo' };
const mapDayNumber: Record<number, string> = { 0: 'domingo', 1: 'segunda', 2: 'terca', 3: 'quarta', 4: 'quinta', 5: 'sexta', 6: 'sabado' };
...
export function findDayData(
    ...
    return aderenciaDia.find(d => {
        ...
        if (diaApi) {
            ...
            const keyApi = mapDiasFull[diaApiNorm] || diaApiNorm;
            const keyRef = mapDiasFull[diaRefNorm] || diaRefNorm;
        ...
        if (d.dia_iso) {
            ...
            const keyRefNorm = mapDiasFull[diaRefNorm] || diaRefNorm;
