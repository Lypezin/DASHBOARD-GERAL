...
export function processarOrigemIndividual(origemNome: string, origemSemana1: any, origemSemana2: any): OrigemProcessada {
    ...
    const horasPlanejadasSem1 = origemSemana1?.segundos_planejados
        ? origemSemana1.segundos_planejados / 3600
        : converterHorasParaDecimal(origemSemana1?.horas_a_entregar || '0');

    const horasPlanejadasSem2 = origemSemana2?.segundos_planejados
        ? origemSemana2.segundos_planejados / 3600
        : converterHorasParaDecimal(origemSemana2?.horas_a_entregar || '0');
