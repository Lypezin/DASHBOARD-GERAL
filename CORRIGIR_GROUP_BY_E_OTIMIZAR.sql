-- =====================================================================
-- CORREÇÃO URGENTE: GROUP BY e Otimização de Disk IO
-- =====================================================================
-- Problemas:
-- 1. Erro GROUP BY na consulta 'dia'
-- 2. Alto consumo de Disk IO
-- 
-- Soluções:
-- 1. Corrigir subconsulta correlacionada
-- 2. Remover work_mem excessivo (256MB -> 128MB)
-- 3. Reduzir statement_timeout (120s -> 60s)
-- =====================================================================
...
-- CORREÇÕES APLICADAS:
-- =====================================================================
-- ✅ Corrigido GROUP BY em 'dia' - movido data_do_periodo para subquery
-- ✅ Reduzido work_mem: 256MB -> 128MB
-- ✅ Reduzido statement_timeout: 120s -> 60s
-- ✅ Mantido filtro de semana na consulta semanal
-- =====================================================================
