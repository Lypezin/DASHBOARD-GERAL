...
-- =====================================================================
-- Problema 1: Materialized view vazia
-- Problema 2: Dashboard sem dados
-- Problema 3: UTR com timeout
-- Problema 4: RLS bloqueando dados
-- =====================================================================

-- =============================================================================
-- PARTE 1: DESABILITAR RLS TEMPORARIAMENTE (TESTE)
-- =============================================================================
...
-- =============================================================================
-- PARTE 2: RECRIAR MATERIALIZED VIEW COM DADOS
-- =============================================================================
...
-- =============================================================================
-- PARTE 3: RECRIAR dashboard_resumo (CORRIGIDO)
-- =============================================================================
...
DECLARE
  ...
  v_base_filter text;
BEGIN
  -- Buscar dimensoes ANTES (fora do format) - FIX PARA ARRAYS
  ...
  -- Adicionar dimensoes (FORA do format) - FIX ARRAYS
...
-- =============================================================================
-- PARTE 4: OTIMIZAR UTR (MAIS RÁPIDO)
-- =============================================================================
...
SELECT 
  '✅ VERIFICAÇÃO' as tipo,
  'Registros na MV' as item,
  COUNT(*)::text as valor
FROM public.mv_aderencia_agregada;

-- Testar dashboard_resumo
SELECT 
  '✅ VERIFICAÇÃO' as tipo,
  'Totais no dashboard' as item,
  (public.dashboard_resumo(NULL, NULL, NULL, NULL, NULL)->>'totais')::text as valor;

-- Testar dimensoes (arrays)
SELECT 
  '✅ VERIFICAÇÃO' as tipo,
  'Tipo de pracas' as item,
  jsonb_typeof((public.dashboard_resumo(NULL, NULL, NULL, NULL, NULL))->'dimensoes'->'pracas') as valor;

-- Testar UTR
SELECT 
  '✅ VERIFICAÇÃO' as tipo,
  'UTR geral' as item,
  (public.calcular_utr(NULL, NULL, NULL, NULL, NULL)->'geral')::text as valor;
