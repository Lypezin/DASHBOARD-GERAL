-- =====================================================================
-- CORRIGIR CÁLCULO DE ADERÊNCIA - V2 (COM CONVERSÃO DE TIPOS)
-- =====================================================================
-- Corrige o erro de multiplicação TEXT * INTEGER
-- Converte duracao_do_periodo para NUMERIC antes de multiplicar
-- =====================================================================
    ...
    'semanal', COALESCE((
      ...
      FROM (
        SELECT 
          ...
          ROUND(
            (SELECT SUM(DISTINCT 
              COALESCE(duracao_do_periodo::NUMERIC, 0) * 
...
-- Converte duracao_do_periodo::NUMERIC antes de multiplicar
-- =====================================================================
