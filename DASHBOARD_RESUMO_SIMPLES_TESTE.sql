-- =====================================================================
-- TESTE: dashboard_resumo SIMPLIFICADO (só corridas, sem aderência)
-- =====================================================================

-- Remover função antiga
DROP FUNCTION IF EXISTS public.dashboard_resumo(integer, integer, text, text, text);

-- Criar função SIMPLIFICADA para teste
...
-- Mensagem de sucesso
SELECT 
  '✅ FUNÇÃO SIMPLIFICADA CRIADA!' as status,
  'Teste apenas com dados de corridas (sem aderência de horas)' as descricao;
